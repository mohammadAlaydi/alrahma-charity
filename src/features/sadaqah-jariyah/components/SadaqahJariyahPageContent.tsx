...
export function SadaqahJariyahPageContent() {
  ...
  return (
    <section className="w-full pt-8 pb-10 md:pt-[100px] md:pb-[100px]" dir="rtl">
      <Container>
        <div className="flex flex-col xl:flex-row w-full items-start justify-between gap-12 lg:gap-20">
          {/* Right content column - appears on the RIGHT in RTL layout */}
          <div className="flex w-full xl:max-w-[736px] flex-col items-start gap-[48px]">
