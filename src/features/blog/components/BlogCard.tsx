...
export function BlogCard({ post }: BlogCardProps) {
  ...
  return (
    <article className="flex h-full w-full flex-col overflow-hidden rounded-[20px] border-[0.5px] border-[rgba(0,0,0,0.3)] border-solid bg-white pt-[8px] px-[8px] pb-0">
      {/* Feature Image */}
      <div className="relative h-[262px] w-full overflow-clip rounded-[14px]">
        ...
        <div className="absolute left-[27px] top-[20px] flex w-full items-start justify-end">
      ...
      <div className="flex w-full flex-col gap-[24px] items-end pb-[32px] pt-0 px-[16px]">
        {/* User Details */}
        ...
        <div className="flex w-full items-start">
          <Link
            href={`/blog/${post.id}`}
            className="flex items-center justify-center gap-[10px] px-[16px] py-[8px] transition-opacity hover:opacity-80"
          >
