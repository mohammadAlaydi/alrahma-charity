...
import { buttonVariants } from "@/components/ui/Button"; // Assuming Button exports buttonVariants, checking if it exports it or if I need to mock it. usually it does.
    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day_selected:
                    "bg-[#2D9F75] text-white hover:bg-[#2D9F75] hover:text-white focus:bg-[#2D9F75] focus:text-white",
