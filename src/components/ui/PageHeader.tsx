...
export function PageHeader({ title, subtitle, subtitleIcon, breadcrumbs }: PageHeaderProps) {
  return (
    <div className="flex w-full md:w-[341px] flex-col items-center md:items-start" dir="rtl">
      ...
      {subtitle && (
        <div className="mb-2 md:mb-4 flex h-[30px] items-center gap-[5px] whitespace-nowrap justify-center md:justify-end">
          ...
          <p className="font-['Playpen_Sans_Arabic',var(--font-cairo),sans-serif] text-base md:text-[20px] font-normal leading-[1.5] text-[#B4BB5F] text-right whitespace-nowrap">
            {subtitle}
          </p>
        </div>
      )}
      ...
      <h1 className="font-['Alexandria',var(--font-alexandria),sans-serif] text-[32px] md:text-[58px] font-semibold leading-tight md:leading-[1.6] text-[#0D0D0D] flex h-auto md:h-[93px] w-full items-center justify-center md:justify-start text-center md:text-right">
        {title}
      </h1>
