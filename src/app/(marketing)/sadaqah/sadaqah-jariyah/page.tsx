...
export default function SadaqahJariyahPage() {
  return (
    <div className="relative min-h-screen bg-white">
      ...
      {/* WhatsApp Icon - Positioned as per Figma design */}
      <div className="absolute right-[80px] top-[calc(50%-128.66px)] translate-y-[-50%] z-10 hidden xl:block pointer-events-none">
        <a
          href="https://wa.me/905357829980"
          target="_blank"
          rel="noopener noreferrer"
          className="block pointer-events-auto transition-all hover:scale-110"
